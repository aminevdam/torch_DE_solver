...
cb_es = EarlyStopping(eps=1e-6, no_improvement_patience=500, info_string_every=1000)
...
model.train(optimizer=optimizer, epochs=1e5, save_model=True,  callbacks=[cb_es, cb_plots])
